...
Only about **10% of customers** have a securities account. This makes stratified partitioning essential.
...
Both datasets preserve the original class proportions. This is **critical** for meaningful model evaluation.
...
In classification, predictions are often probabilities. To evaluate performance, we must:
